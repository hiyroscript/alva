...
test('#0001\'s Basic Attacks: ba1 Low horizontal, ba2 High vertical, midairBa1 Mid reversed vertical, midairBa2 Low vertical', () => {
  ...
  assert.deepEqual(def.attacks.midairBa2.knockback, { axis: 'vertical', level: 'low' });
  ...
  assert.deepEqual(fighter.attacks.midairBa2.knockback, { x: 0, y: 480 });
