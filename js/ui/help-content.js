  ...
  return el('div', { class: 'info-grid' }, [
    ...
    card('Movement', [
      el('ul', { class: 'info-list' }, [
        ...
        el('li', { text: 'Launched hard into a wall, the floor or a ceiling, a fighter rebounds off it and can ricochet on to the next surface, a little weaker each time: read the rebound and chase it. Walking, jumping and landing never bounce.' }),
