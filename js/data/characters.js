...
export const CHARACTERS = [
  {
    ...
    chargedTechniques: {
      ...
      rasenRush: {
        ...
        // horizontally only, so the lift stays the same slight one.
        explosionHit: {
          damage: 15,
    ...
    // launch along the same axis. `damage` is how much accumulated Knockback
    // a hit adds: 5 for either BA1, 10 for either BA2.
    attacks: {
